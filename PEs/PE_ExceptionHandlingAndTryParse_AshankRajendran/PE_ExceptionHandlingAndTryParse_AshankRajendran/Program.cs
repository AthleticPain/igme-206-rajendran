namespace PE_ExceptionHandlingAndTryParse_AshankRajendran
{
    internal class Program
    {
        ...
        public static int GetValidIntegerInput(string prompt, int min, int max)
        {
            ...
            int result = int.Parse(GetPromptedInput(prompt));
            bool isInputValid = false;

            while (result < min || result > max || isInputValid == false)
            {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                //Check for arithmetic overflow exception
                ...
                //check for invalid input (format exception)
